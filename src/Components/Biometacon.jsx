...
const Biometacon = () => {
  ...
  return (
    <div className="relative overflow-hidden h-[50vh] m-4 flex items-center justify-center text-center bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      {/* Content Section */}
      <motion.div
