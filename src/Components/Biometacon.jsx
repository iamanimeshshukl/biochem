...
const Biometacon = () => {
  ...
  return (
    <div className="relative overflow-hidden min-h-screen m-4 flex items-center justify-center text-center bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      ...
      {/* Content Section */}
      <motion.div
        className="relative z-10 max-w-4xl mx-4 p-6 md:p-12 rounded-lg bg-white bg-opacity-90 shadow-2xl text-gray-800"
        ref={textRef}
        initial={{ scale: 0.95 }}
        animate={{ scale: 1 }}
      ...
      >
        ...
        <p className="mt-4 text-sm md:text-base text-gray-600">
          Scheduled for <span className="font-semibold text-indigo-500">29th-31th March 2025</span>, this event will bring together industry leaders and academic pioneers to address pressing global challenges.
        </p>
        <p className="mt-4 text-sm md:text-base text-gray-600">
