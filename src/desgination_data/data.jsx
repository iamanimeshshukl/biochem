    ...
    members: [
      {
        ...
        img: "src/assets/committee_data/Dipteek.jpg", // Replace with the actual image path
      },
      {
    ...
    members: [
      {
        ...
        img: "src/assets/committee_data/Lalit Kumar Singh.png", // Replace with the actual image path
      },
    ],
  },
  {
    ...
    members: [
      {
        ...
        img: "src/assets/committee_data/Prof._Ajay_Kumar_Singh.png", // Replace with the actual image path
      },
      {
    ...
    members: [
      {
        ...
        img: "src/assets/committee_data/Shravan Kumar.png", // Replace with the actual image path
      },
      {
        name: "Dr. Rajkamal Kushwaha, Assistant Professor, Biochemical Engg., HBTU Kanpur",
        img: "src/assets/committee_data/Rajkamal Kushwaha.png", // Replace with the actual image path
      },
    ],
  },
  {
    ...
    members: [
      {
        ...
        img: "src/assets/committee_data/Roma agahari.png", // Replace with the actual image path
      },
      {
