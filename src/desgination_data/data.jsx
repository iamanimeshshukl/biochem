      ...
      members: [
        {
          ...
          img: "path-to-image/prof-samsher.jpg", // Replace with the actual image path
        },
      ],
    },
    {
      ...
      members: [
        {
          name: "Prof. D. Parmar, Pro-VC, HBTU Kanpur",
          img: "path-to-image/prof-parmar.jpg", // Replace with the actual image path
        },
        {
      ...
      members: [
        {
          ...
          img: "path-to-image/prof-lalit.jpg", // Replace with the actual image path
        },
      ],
    },
    {
      ...
      members: [
        {
          ...
          img: "path-to-image/prof-ajay.jpg", // Replace with the actual image path
        },
        {
          name: "Shri Brajesh Singh, Biochemical Engg., HBTU Kanpur",
          img: "path-to-image/shri-brajesh.jpg", // Replace with the actual image path
        },
      ],
    },
    {
      ...
      members: [
        {
          ...
          img: "path-to-image/dr-shravan.jpg", // Replace with the actual image path
        },
        {
          name: "Dr. Rajkamal Kushwaha, Assistant Professor, Biochemical Engg., HBTU Kanpur",
          img: "path-to-image/dr-rajkamal.jpg", // Replace with the actual image path
        },
      ],
    },
    {
      ...
      members: [
        {
          ...
          img: "path-to-image/ms-roma.jpg", // Replace with the actual image path
        },
        {
